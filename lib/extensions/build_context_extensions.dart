...
extension BuildContextEntension<T> on BuildContext {
  ...
  T readProvider(ProviderListenable<T> provider) {
    return ProviderScope.containerOf(this, listen: false).read(provider);
  }

  T watchProvider(ProviderListenable<T> provider) {
    return ProviderScope.containerOf(this, listen: true).read(provider);
  }
}
